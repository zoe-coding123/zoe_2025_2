...
class GameLevelMountain {
  constructor(path) {
    this.name = 'GameLevelMountain';
    ...
    // Background data
    const image_src_mountain = path + "/images/gamify/mountains.png"; // be sure to include the path
    const image_data_mountain = {
        name: 'mountains',
        greeting: "Welcome to the desert!  It is hot and dry here, but there are many adventures to be had!",
        src: image_src_mountain,
        pixels: {height: 960, width: 1920}
    };
    ...
    const sprite_data_nomad = {
        ...
        INIT_POSITION: { x: (width * 3 / 4), y: (height * 19 / 24)},
    ...
    const sprite_data_robot = {
        ...
        INIT_POSITION: { x: (width * 3 / 4), y: (height * 7 / 8)},
...
const sprite_data_htmlhank = {
    ...
    this.objects = [
      { class: Background, data: image_data_mountain },
...
export default GameLevelMountain;